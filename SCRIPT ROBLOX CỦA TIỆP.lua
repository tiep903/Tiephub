...
|____/|_|\___|\__,_|   |_| |_| |_|_| |____/| .__/ \__,_|\___\___|
                                           |_|                                         
Si�u Th Space Cm �n Bn � Tin T�ng V� S Dng Dch V Ca Ch�ng T�i, Nu Thy Hu �t Hy Chia S Cho Bn B� Ca Bn !!
- Website: Chờ Update
- Page: Đang Update
- Facebook Admin: https://www.facebook.com/tiep.luong.5477272?mibextid=JRoKGi

--// L�u :
- Kh�ng ��c Share Hay Crack M Ngun N�y Cho Ai! Nu Kh�ng Bn S B Ban IP Khi Website Vnh Vin!
- Ch�ng T�i Kh�ng Nhn H Tr Nhng M Ngun Min Ph�, Xin �ng Bo V Sao. To Ticket H Tr Ca Website Ti: https://dash.sieuthispace.xyz/client/ticket
- Nu Bn Edit Source V� Up Web Share Nh Obfuscate Script. Nu Bn C� Tin Th S Dng: Lura.Ph, Luarmor.Net | Nu Bn Kh�ng C� Tin Th D�ng: luaobfuscate.com, MoonSec, 77Fuscate,... Nh�!
]]
---///--------------------------------------------------------------\\\---
��ng Bi Phucdz
-- No Skid
...
local Window = OrionLib:MakeWindow({
    Name = "Tiệp Hub", 
    HidePremium = false,
    IntroText = "Tiệp Library", 
    SaveConfig = true, 
    ConfigFolder = "Tiệp Hub"
})
